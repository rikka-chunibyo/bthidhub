sudo rm -rf "/Library/LaunchDaemons/com.rikka.bthidhub-reconnect.plist"
...
sudo launchctl load system "/Library/LaunchDaemons/com.rikka.bthidhub-reconnect.plist" # this gives an error but it might still work, unless it doesn't go on startup? idk I'll figure it out later
